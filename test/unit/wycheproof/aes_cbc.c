...
int handle_map_key(void *ctx, const unsigned char *key, size_t length) {
    (void)ctx;
...
int handle_string(void *ctx, const unsigned char *val, size_t length) {
    (void)ctx;
...
int handle_boolean(void *ctx, int boolVal) {
    (void)ctx;
...
int handle_number(void *ctx, const char *val, size_t length) {
    (void)ctx;
    char num_str[64];
